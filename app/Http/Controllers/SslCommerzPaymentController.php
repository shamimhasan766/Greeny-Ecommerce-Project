...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data = array();
        $post_data['total_amount'] = ($data['total']+$data['charge'] - $data['discount']); # You cant not pay less than 10
    ...
    public function success(Request $request)
    {
        ...
        $message = "Your Ecommerce Order has been placed. Order Id : #$order_id . You will get your parcel soon... your total payment amount TK ".($data->total - $data->discount)+ $data->charge ."--/ has been paid by SslCommerz. Thank You";
