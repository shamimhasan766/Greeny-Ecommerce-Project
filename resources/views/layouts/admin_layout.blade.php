...
<!-- Mirrored from vetra.laborasyon.com/demos/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Mar 2024 18:06:32 GMT -->
<head>
    <meta charset="UTF-8">
...
<div class="menu">
    ...
    <div class="menu-body">
        <div class="dropdown">
            <a href="#" class="d-flex align-items-center" data-bs-toggle="dropdown">
                <div class="avatar me-3">
                    <img src="{{Auth::user()->profile->photo ? asset(Auth::user()->profile->photo) : asset('admin/assets/images/user/man_avatar3.jpg')}}" class="rounded-circle" alt="image">
                </div>
                <div>
        ...
        <ul>
            ...
            <li>
                <a class="{{ request()->url() === route('dashboard') ? 'active' : '' }}" href="{{ route('dashboard') }}"
                    href="index.html">
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a class="{{ request()->url() === route('all.product') ? 'active' : '' }}" href="{{ route('all.product') }}">List
                            View</a>
                    </li>
                    <li>
                        <a class="{{ request()->url() === route('all.product.grid') ? 'active' : '' }}" href="{{ route('all.product.grid') }}">Grid
                            View</a>
                    </li>
                    <li>
                        <a class="{{ request()->url() === route('add.product') ? 'active' : '' }}" href="{{ route('add.product') }}">Add Product</a>
                    </li>
                    <li>
                        <a class="{{ request()->url() === route('trash.product') ? 'active' : '' }}" href="{{ route('trash.product') }}">Trash</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            <li>
                                <a class="{{ request()->url() === route('all.category') ? 'active' : '' }}" href="{{ route('all.category') }}">All Category</a>
                            </li>
                            <li>
                                <a class="{{ request()->url() === route('add.category') ? 'active' : '' }}" href="{{ route('add.category') }}">Add Category</a>
                            </li>
                            <li>
                                <a class="{{ request()->url() === route('trash.category') ? 'active' : '' }}" href="{{ route('trash.category') }}">Trash</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            <li>
                                <a class="{{ request()->url() === route('all.sub.category') ? 'active' : '' }}" href="{{ route('all.sub.category') }}">All Sub Category</a>
                            </li>
                            <li>
                                <a class="{{ request()->url() === route('add.sub.category') ? 'active' : '' }}" href="{{ route('add.sub.category') }}">Add Sub Category</a>
                            </li>
                            <li>
                                <a class="{{ request()->url() === route('trash.sub.category') ? 'active' : '' }}" href="{{ route('trash.sub.category') }}">Trash</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            <li>
                                <a class="{{ request()->url() === route('all.tag') ? 'active' : '' }}" href="{{ route('all.tag') }}">All Tags</a>
                            </li>
                            <li>
                                <a class="{{ request()->url() === route('add.tag') ? 'active' : '' }}" href="{{ route('add.tag') }}">Add Tag</a>
                            </li>
                            <li>
                                <a class="{{ request()->url() === route('trash.tag') ? 'active' : '' }}" href="{{ route('trash.tag') }}">Trash</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            <li>
                                <a class="{{ request()->url() === route('all.brand') ? 'active' : '' }}" href="{{ route('all.brand') }}">All Brands</a>
                            </li>
                            <li>
                                <a class="{{ request()->url() === route('add.brand') ? 'active' : '' }}" href="{{ route('add.brand') }}">Add Brand</a>
                            </li>
                            <li>
                                <a class="{{ request()->url() === route('trash.brand') ? 'active' : '' }}" href="{{ route('trash.brand') }}">Trash</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            <li>
                                <a class="{{ request()->url() === route('all.color') ? 'active' : '' }}" href="{{ route('all.color') }}">All Colors</a>
                            </li>
                            <li>
                                <a class="{{ request()->url() === route('add.color') ? 'active' : '' }}" href="{{ route('add.color') }}">Add Color</a>
                            </li>
                            <li>
                                <a class="{{ request()->url() === route('trash.color') ? 'active' : '' }}" href="{{ route('trash.color') }}">Trash</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            <li>
                                <a class="{{ request()->url() === route('all.size') ? 'active' : '' }}" href="{{ route('all.size') }}">All Sizes</a>
                            </li>
                            <li>
                                <a class="{{ request()->url() === route('add.size') ? 'active' : '' }}" href="{{ route('add.size') }}">Add Size</a>
                            </li>
                            <li>
                                <a class="{{ request()->url() === route('trash.size') ? 'active' : '' }}" href="{{ route('trash.size') }}">Trash</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <li>
                <a class="{{ request()->url() === route('user.profile') ? 'active' : '' }}" href="{{ route('user.profile') }}">
                    <span class="nav-link-icon">
                        <i class="bi bi-person"></i>
                    </span>
                    <span>Profile</span>
            ...
            <li>
                ...
                <ul>
                    <li><a class="{{ request()->url() === route('user.list') ? 'active' : '' }}"  href="{{ route('user.list') }}">List View</a></li>
            ...
            <li>
                <a class="{{ request()->url() === route('user.setting') ? 'active' : '' }}" href="{{ route('user.setting') }}">
                    <span class="nav-link-icon">
                        <i class="bi bi-gear"></i>
                    </span>
                    <span>Settings</span>
    ...
    <div class="header-bar ms-auto">
        <ul class="navbar-nav justify-content-end">
                    ...
                    <div class="dropdown-menu-body">
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{asset('admin/assets/')}}/images/products/3.jpg" class="rounded" width="60"
                                         alt="...">
                                </a>
                                <div>
                                    <h6>Digital clock</h6>
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{asset('admin/assets/')}}/images/products/4.jpg" class="rounded" width="60"
                                         alt="...">
                                </a>
                                <div>
                                    <h6>Toy Car</h6>
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{asset('admin/assets/')}}/images/products/5.jpg" class="rounded" width="60"
                                         alt="...">
                                </a>
                                <div>
                                    <h6>Sunglasses</h6>
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{asset('admin/assets/')}}/images/products/6.jpg" class="rounded" width="60"
                                         alt="...">
                                </a>
                                <div>
                                    <h6>Cake</h6>
            ...
            <li class="nav-item ms-3">
                    <a href="{{ route('add.product') }}" class="btn btn-primary btn-icon">
...
<!-- Mirrored from vetra.laborasyon.com/demos/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Mar 2024 18:07:12 GMT -->
</html>
