    ...
    <table class="table table-custom table-lg mb-0" id="customers">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-end">
                    <td>
                        <a title="Restore" href="{{ route('restore.category', $category->id) }}" class="edit btn btn-success btn-icon"><i class="fa-solid fa-rotate-left"></i></a>
                        <a title="Permanent Delete" href="{{ route('force.delete.category', $category->id) }}" class="delete btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                    </td>
                </td>
            </tr>
            @endforeach
