                ...
                <form action="{{ route('inventory.store', $product->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="color_id">
                            ...
                            <option {{ $color->color_name == 'NA'? 'selected': '' }} value="{{ $color->id }}">{{ $color->color_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="size_id">
                            ...
                            <option {{ $size->size_name == 'NA'? 'selected': '' }} value="{{ $size->id }}">{{ $size->size_name }}</option>
                            @endforeach
                        </select>
                        <p><a class="text-success m-2" target="blank" href="{{ route('add.size') }}">not getting your size?</a></p>
                    </div>
                    <div class="mb-3">
