    ...
    <table class="table table-custom table-lg mb-0" id="customers">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <img height="40px" src="{{ asset($brand->logo) }}" alt="">
                </td>
                <td>{{ $brand->name }}</td>
                <td>{{ $brand->deleted_at }}</td>
                <td class="text-end">
                    <td>
                        <a title="Restore" href="{{ route('restore.brand', $brand->id) }}" class="edit btn btn-success btn-icon"><i class="fa-solid fa-rotate-left"></i></a>
                        <a title="Permanent Delete" href="{{ route('force.delete.brand', $brand->id) }}" class="delete btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                    </td>
                </td>
            </tr>
            @endforeach
