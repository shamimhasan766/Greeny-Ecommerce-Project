                        ...
                        <tr>
                            ...
                            <td>
                                @if (Carbon\Carbon::now() > $coupon->validity)
                                    <span class="badge badge-warning text-warning">Expired {{ Carbon\Carbon::now()->diffInDays($coupon->validity)}} Days Ago</span>
                                    @else
                                    <span class="badge badge-success text-success">{{ Carbon\Carbon::now()->diffInDays($coupon->validity)}} Days Remaining</span>
                                @endif
                            </td>
