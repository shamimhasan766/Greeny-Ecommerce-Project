                ...
                <div class="table-responsive">
                    <table class="table table-custom mb-0" id="recent-products">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#">
                                    <img src="{{asset('admin/assets/')}}/images/products/10.jpg" class="rounded" width="40"
                                        alt="...">
                                </a>
                            </td>
                            <td>Cookie</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#">
                                    <img src="{{asset('admin/assets/')}}/images/products/7.jpg" class="rounded" width="40"
                                        alt="...">
                                </a>
                            </td>
                            <td>Glass</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#">
                                    <img src="{{asset('admin/assets/')}}/images/products/8.jpg" class="rounded" width="40"
                                        alt="...">
                                </a>
                            </td>
                            <td>Headphone</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#">
                                    <img src="{{asset('admin/assets/')}}/images/products/9.jpg" class="rounded" width="40"
                                        alt="...">
                                </a>
                            </td>
                            <td>Perfume</td>
