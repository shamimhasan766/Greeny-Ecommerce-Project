    ...
    <table class="table table-custom table-lg mb-0" id="customers">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $product->sku }}</td>
                <td><a href="{{ route('product.status', $product->id) }}" class="btn btn-{{ $product->status == 0 ? 'danger' : 'success' }}">{{ $product->status == 0 ? 'deactive' : 'active' }}</a></td>
                ...
                <td class="text-end">
                    <div class="d-flex">
                        <div class="dropdown ms-auto">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="{{ route('product.view', $product->id) }}" class="dropdown-item">View</a>
                                <a href="{{ route('inventory', $product->id) }}" class="dropdown-item">Inventory</a>
                                <a href="{{ route('product.edit', $product->id) }}" class="dropdown-item">Edit</a>
                                <a href="{{ route('delete.product', $product->id) }}" class="dropdown-item">Delete</a>
                            </div>
                        </div>
                    </div>
                </td>
