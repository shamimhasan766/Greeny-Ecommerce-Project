                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-5">
                                ...
                                <div class="strong text-danger">{{ $message }}</div>
                                @enderror
                                <img height="150" class="mt-3" src="{{ asset($product->preview_img) }}" alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-5">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="mr-2">
                                        <img height="150" class="me-3" src="{{ asset($gallery->gallery_path) }}" alt="">
                                        <a href="{{ route('gallery.image.delete', $gallery->id) }}" class="btn btn-sm btn-danger mt-2 d-block me-3">Delete</a>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
